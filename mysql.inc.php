...
// (1) It contains the database access information. 
// (2) It establishes a connection to MySQL and selects the database.
// (3) It defines a function for making data safe to use in queries.

// Set the database access information as constants:
DEFINE ('DB_USER', 'root');
DEFINE ('DB_PASSWORD', '');
DEFINE ('DB_HOST', 'localhost');
DEFINE ('DB_NAME', 'buyBook');
